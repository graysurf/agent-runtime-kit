...
- Prior pin: `v0.29.0` at `0f757df` (`chore(release): bump cli versions to
  ...
  memory index is unavailable. Earlier release history retained below.
  `v0.25.8` at `4d0d621`
