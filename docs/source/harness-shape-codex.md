...
| 14 | `state_home` | yes | env var + `agent-out` allocation | 0.130.0 | v1.19.3 (`agent-out >=1.19.3` floor for reviewed cleanup plan/apply; rendered `path-for` stays introduced at `>=1.19.2`) |
