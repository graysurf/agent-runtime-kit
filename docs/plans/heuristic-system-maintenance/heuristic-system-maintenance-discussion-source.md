...
- Recommended plan: docs/plans/heuristic-system-maintenance/heuristic-system-maintenance-plan.md
- Recommended execution state: docs/plans/heuristic-system-maintenance/heuristic-system-maintenance-execution-state.md
...
Create
`docs/plans/heuristic-system-maintenance/heuristic-system-maintenance-plan.md`
