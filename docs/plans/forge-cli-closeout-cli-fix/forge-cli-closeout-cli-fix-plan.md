...
- Primary source: docs/plans/forge-cli-closeout-cli-fix/forge-cli-closeout-cli-fix-discussion-source.md
...
- In scope:
  - New `docs/plans/forge-cli-closeout-cli-fix/` plan bundle (this
  ...
  - Tracking-issue artifacts under
    `docs/plans/forge-cli-closeout-cli-fix/tracking-issue/`.
- Out of scope:
...
- **Validation**:
  - `plan-tooling validate --file docs/plans/forge-cli-closeout-cli-fix/forge-cli-closeout-cli-fix-plan.md --format text --explain`
...
| Command | When | Notes |
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/forge-cli-closeout-cli-fix/forge-cli-closeout-cli-fix-plan.md --format text --explain` | before Sprint 2 commit | Exit 0. |
