...
- Source document: docs/plans/2026-05-23-retire-claude-kit-scripts/retire-claude-kit-scripts-plan.md
- Plan document: docs/plans/2026-05-23-retire-claude-kit-scripts/retire-claude-kit-scripts-plan.md
...
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/2026-05-23-retire-claude-kit-scripts/retire-claude-kit-scripts-plan.md --explain` | pass | Clean. |
