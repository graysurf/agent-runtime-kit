...
- Primary source: docs/plans/2026-05-25-skill-governance-count-refresh/skill-governance-count-refresh-discussion-source.md
...
- **Location**:
  ...
  - `tests/runtime-smoke/`
  - `tests/golden/`
  - `docs/plans/2026-05-25-skill-governance-count-refresh/skill-governance-count-refresh-execution-state.md`
...
- **Location**:
  - `docs/plans/2026-05-25-skill-governance-count-refresh/skill-governance-count-refresh-execution-state.md`
  - `docs/plans/2026-05-25-skill-governance-count-refresh/`
