...
- Source document: docs/plans/2026-05-23-codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-plan.md
...
- Task 2.4: `DEVELOPMENT.md`, `docs/source/inventory-target-architecture.md`,
  and `docs/plans/2026-05-22-codex-skill-discovery-cutover/codex-skill-discovery-cutover-execution-state.md`
