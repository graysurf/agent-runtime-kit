...
- Primary source: docs/plans/skill-lifecycle-management/skill-lifecycle-management-discussion-source.md
...
- **Location**:
  - `docs/plans/skill-lifecycle-management/skill-lifecycle-management-execution-state.md`
  - `docs/source/nils-cli-surface.md`
