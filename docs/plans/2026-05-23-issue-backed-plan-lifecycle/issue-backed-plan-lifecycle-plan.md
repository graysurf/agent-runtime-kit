...
- Primary source: docs/plans/2026-05-23-issue-backed-plan-lifecycle/issue-backed-plan-lifecycle-discussion-source.md
...
- Commands:
  ...
  - `plan-tooling validate --file docs/plans/2026-05-23-issue-backed-plan-lifecycle/issue-backed-plan-lifecycle-plan.md --format text --explain`
...
- **Location**:
  - docs/plans/2026-05-23-issue-backed-plan-lifecycle/issue-backed-plan-lifecycle-discussion-source.md
  - docs/plans/2026-05-23-issue-backed-plan-lifecycle/issue-backed-plan-lifecycle-execution-state.md
