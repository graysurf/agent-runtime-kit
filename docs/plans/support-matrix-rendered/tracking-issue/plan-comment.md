...
- Path: `docs/plans/support-matrix-rendered/support-matrix-rendered-plan.md`
...
them. Plan F4 from the closed `docs/plans/support-matrix/` plan
...
- Primary source: docs/plans/support-matrix-rendered/support-matrix-rendered-discussion-source.md
- Source type: discussion-to-implementation-doc
- Recommended plan: docs/plans/support-matrix-rendered/support-matrix-rendered-plan.md
- Recommended execution state: docs/plans/support-matrix-rendered/support-matrix-rendered-execution-state.md
- Closed plan to cite for background:
  - docs/plans/support-matrix/support-matrix-discussion-source.md (origin of Plan F4)
  - docs/plans/support-matrix/support-matrix-execution-state.md (17/17 row evidence trail)
...
- In scope:
  - New `docs/plans/support-matrix-rendered/` plan bundle (this
  ...
  - Dry-run tracking-issue artifacts under
    `docs/plans/support-matrix-rendered/tracking-issue/`.
...
- **Location**:
  - `docs/plans/support-matrix-rendered/support-matrix-rendered-execution-state.md`
    (Decision record).
...
- **Location**:
  - `docs/plans/support-matrix-rendered/tracking-issue/` (new
    directory).
...
- **Validation**:
  - `plan-tooling validate --file docs/plans/support-matrix-rendered/support-matrix-rendered-plan.md --explain`
...
- **Validation**:
  - `gh pr list --head feat/support-matrix-rendered-live-issue
    --json state,number`
  - `git grep -n 'issues/' docs/plans/support-matrix-rendered/support-matrix-rendered-execution-state.md`

## Validation

| Command | When | Notes |
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/support-matrix-rendered/support-matrix-rendered-plan.md --format text --explain` | before Sprint 4 commit | Run inside the worktree. |
