...
- Source document: docs/plans/codex-skill-discovery-cutover/codex-skill-discovery-cutover-plan.md
...
`docs/plans/codex-skill-surface-acceptance-cutover/` for the live protocol,
