...
- Path: `docs/plans/deliver-autonomous-closeout/deliver-autonomous-closeout-plan.md`
...
- Primary source: docs/plans/deliver-autonomous-closeout/deliver-autonomous-closeout-discussion-source.md
...
- In scope:
  - New `docs/plans/deliver-autonomous-closeout/` plan bundle (this
  ...
  - Tracking-issue artifacts under
    `docs/plans/deliver-autonomous-closeout/tracking-issue/`.
- Out of scope:
...
- **Location**:
  - `docs/plans/deliver-autonomous-closeout/tracking-issue/` (new
    directory).
...
- **Validation**:
  - `plan-tooling validate --file docs/plans/deliver-autonomous-closeout/deliver-autonomous-closeout-plan.md --explain`
...
| Command | When | Notes |
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/deliver-autonomous-closeout/deliver-autonomous-closeout-plan.md --format text --explain` | before Sprint 3 commit | Run inside the worktree. |
