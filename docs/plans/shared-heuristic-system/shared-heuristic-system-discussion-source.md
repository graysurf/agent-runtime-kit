...
- Recommended plan: docs/plans/shared-heuristic-system/shared-heuristic-system-plan.md
- Recommended execution state: docs/plans/shared-heuristic-system/shared-heuristic-system-execution-state.md
...
`docs/plans/shared-heuristic-system/` until the plan is implemented and closed.
...
- `docs/plans/shared-heuristic-system/shared-heuristic-system-plan.md`
