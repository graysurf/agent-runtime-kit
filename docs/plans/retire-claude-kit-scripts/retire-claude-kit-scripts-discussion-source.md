...
- Recommended plan: docs/plans/retire-claude-kit-scripts/retire-claude-kit-scripts-plan.md
- Recommended execution state: docs/plans/retire-claude-kit-scripts/retire-claude-kit-scripts-execution-state.md
