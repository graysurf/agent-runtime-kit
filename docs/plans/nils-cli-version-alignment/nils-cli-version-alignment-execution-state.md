...
| --- | --- | --- | --- |
| `plan-tooling validate --file docs/plans/nils-cli-version-alignment/nils-cli-version-alignment-plan.md --format text --explain` | pass | Plan bundle validates after adding plan and execution-state files. | n/a |
