...
- Recommended execution state:
  docs/plans/01-skeleton-and-schema/01-skeleton-and-schema-execution-state.md
...
- `plan-tooling validate --file docs/plans/01-skeleton-and-schema/01-skeleton-and-schema-plan.md --format text --explain`
- `yamllint manifests/`
