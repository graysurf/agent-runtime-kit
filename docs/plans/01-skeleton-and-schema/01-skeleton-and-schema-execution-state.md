...
> (current status at 2026-05-20: complete-with-deviation — Tasks 3.3 + 3.4
> deferred to the next normal `sympoies/nils-cli` release; issue remains
> open until those tasks ship). Append-only `:session:v1` and
