...
- Path: `docs/plans/2026-05-23-support-matrix/support-matrix-plan.md`
...
- Primary source: docs/plans/2026-05-23-support-matrix/support-matrix-discussion-source.md
...
- In scope:
  - New `docs/plans/2026-05-23-support-matrix/` plan bundle (this file plus the
...
- **Location**:
  - `docs/plans/2026-05-23-support-matrix/tracking-issue/` (new directory).
...
- **Validation**:
  - `review-specialists --plan docs/plans/2026-05-23-support-matrix/support-matrix-plan.md ...`
...
- **Acceptance criteria**:
  - Diff against committed artifacts is empty except for the commit
    field updates.
- **Validation**:
  - `diff -u docs/plans/2026-05-23-support-matrix/tracking-issue/dashboard.md "$(plan-issue record render-dashboard --profile tracking --status in-progress --target-scope support-matrix --current 'Sprint 1 Task 1.1' --next-action 'Sprint 1 Task 1.2' --validation pending --approval pending --title support-matrix --out /dev/stdout)"`
  - `plan-issue record audit --profile tracking --marker-family compat --dir docs/plans/2026-05-23-support-matrix/tracking-issue`
...
- **Validation**:
  ...
  - `git grep -n 'issues/' docs/plans/2026-05-23-support-matrix/support-matrix-execution-state.md`

## Validation

| Command | When | Notes |
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/2026-05-23-support-matrix/support-matrix-plan.md --format text --explain` | before Sprint 2 commit | Run inside the worktree. |
