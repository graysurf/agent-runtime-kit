...
- Path: `docs/plans/2026-05-23-support-matrix/support-matrix-execution-state.md`
...
- Source document: docs/plans/2026-05-23-support-matrix/support-matrix-discussion-source.md
- Plan document: docs/plans/2026-05-23-support-matrix/support-matrix-plan.md
...
| 2.1 | pending | Render tracking issue artifacts (dry-run) | | Output under `docs/plans/2026-05-23-support-matrix/tracking-issue/`. |
...
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/2026-05-23-support-matrix/support-matrix-plan.md --format text --explain` | pending | Required before Sprint 2 commit. |
