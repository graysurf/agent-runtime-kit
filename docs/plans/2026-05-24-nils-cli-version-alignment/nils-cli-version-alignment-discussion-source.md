...
- Recommended plan: docs/plans/2026-05-24-nils-cli-version-alignment/nils-cli-version-alignment-plan.md
- Recommended execution state: docs/plans/2026-05-24-nils-cli-version-alignment/nils-cli-version-alignment-execution-state.md
...
- [F8] Existing plan bundles under `docs/plans/<slug>/` use the
  ...
  (e.g. `docs/plans/2026-05-23-support-matrix/`).
