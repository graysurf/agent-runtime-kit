...
- Path: `docs/plans/2026-05-23-support-matrix-rendered/support-matrix-rendered-execution-state.md`
...
| 4.1 | pending | Render tracking-issue artifacts (dry-run) | | Output under `docs/plans/2026-05-23-support-matrix-rendered/tracking-issue/`. |
...
| --- | --- | --- |
| `plan-tooling validate --file docs/plans/2026-05-23-support-matrix-rendered/support-matrix-rendered-plan.md --format text --explain` | pending | Required before Sprint 4 commit. |
