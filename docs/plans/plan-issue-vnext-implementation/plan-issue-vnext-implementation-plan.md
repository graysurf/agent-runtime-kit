...
- Primary source: docs/plans/plan-issue-vnext-implementation/plan-issue-vnext-implementation-discussion-source.md
...
- **Location**:
  - `docs/plans/plan-issue-vnext-implementation/`
  - `docs/source/plan-issue-redesign/plan-tracking-issue-cli-redesign-v1.md`
...
- **Location**:
  - `docs/plans/plan-issue-vnext-implementation/plan-issue-vnext-implementation-execution-state.md`
  - `docs/source/nils-cli-surface.md`
  - `docs/source/plan-issue-redesign/`
