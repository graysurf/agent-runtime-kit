...
- Recommended plan: docs/plans/skill-governance-count-refresh/skill-governance-count-refresh-plan.md
- Recommended execution state: docs/plans/skill-governance-count-refresh/skill-governance-count-refresh-execution-state.md
...
Use
`docs/plans/skill-governance-count-refresh/skill-governance-count-refresh-plan.md`
