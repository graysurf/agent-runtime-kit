...
- Status: in-progress (Sprint 1 resumed under nils-cli v0.14.0)
- Target scope: whole plan (2-sprint revision)
- Execution window: Sprint 1 active (Sprint 2 next)
- Staged execution confirmation: not applicable
- Current task: Sprint 1 wrap-up (open PR)
- Next task: Sprint 2 Task 2.1 (golden snapshots)
- Last updated: 2026-05-21
- Branch/commit: `feat/plan-03-sprint-1-reporting-bodies-and-manifests` (active; latest on top of `d890b11` + main merge `8e73d38`)
...
| Task 2.1 | pending                                 | Generate and commit render-golden snapshots                                       | n/a                                            | unblocked; pin under v0.14.0 portable script() output                                                  |
| Task 2.2 | pending                                 | Add drift fixtures for the four POC drift classes                                 | n/a                                            | depends on Task 2.1                                                                                    |
| Task 2.3 | done                                    | Confirm clean POC audit-drift exits 0                                             | `audit-drift: clean (0 findings)` under v0.14.0 | re-verified after re-render; SKILL bodies host-portable, siblings present                              |
