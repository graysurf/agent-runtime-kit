...
- Primary source: docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-discussion-source.md
...
- **Location**:
  ...
  - `docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-execution-state.md`
...
- **Validation**:
  ...
  - `plan-tooling validate --file docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-plan.md --format text --explain`
...
- Plan validation:
  - `plan-tooling validate --file docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-plan.md --format text --explain`
- Grouping:
  - `for n in 1 2 3; do plan-tooling batches --file docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-plan.md --sprint "$n" --format json; done`
  - `plan-tooling split-prs --file docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-plan.md --scope sprint --sprint 1 --strategy deterministic --pr-grouping group --pr-group 'Task 1.1=s1-matrix' --pr-group 'Task 1.2=s1-runtime-setup' --pr-group 'Task 1.3=s1-results' --format json`
  - `plan-tooling split-prs --file docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-plan.md --scope sprint --sprint 2 --strategy deterministic --pr-grouping group --pr-group 'Task 2.1=s2-meta' --pr-group 'Task 2.2=s2-media-browser' --pr-group 'Task 2.3=s2-evidence' --pr-group 'Task 2.4=s2-ci' --format json`
  - `plan-tooling split-prs --file docs/plans/06-runtime-skill-acceptance-harness/06-runtime-skill-acceptance-harness-plan.md --scope sprint --sprint 3 --strategy deterministic --pr-grouping per-sprint --format json`
- Harness gates:
  - `bash tests/runtime-smoke/run.sh --mode matrix`
  - `bash tests/runtime-smoke/run.sh --mode install`
  - `bash tests/runtime-smoke/run.sh --mode deterministic`
