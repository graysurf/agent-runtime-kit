...
- [F2] Existing project-skill lifecycle scope already treats
  ...
  `docs/plans/project-skill-lifecycle-management/project-skill-lifecycle-management-discussion-source.md:25-30`
  and
  `docs/plans/project-skill-lifecycle-management/project-skill-lifecycle-management-discussion-source.md:76-88`.
...
- `docs/plans/project-skill-lifecycle-management/project-skill-lifecycle-management-discussion-source.md`
