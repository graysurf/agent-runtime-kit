...
- Primary source: docs/plans/2026-05-20-01-skeleton-and-schema/01-skeleton-and-schema-discussion-source.md
...
- In scope:
  - Top-level skeleton directories: `core/`, `targets/codex/`,
    ...
    `tests/golden/`, `tests/drift/`, `tests/hooks/`, `tests/sandbox/`,
    `tests/projects/`.
...
- Command(s):
  - `ls -d core targets/codex targets/claude manifests scripts tests/golden tests/drift tests/hooks tests/sandbox tests/projects`
...
- **Description**: Create the directory tree the rest of the plan
  ...
  empty structure. The original install placeholder was later superseded by the
  sandbox install fixture surface and is no longer retained. `build/` is NOT created
...
- **Complexity**: 1
- **Acceptance criteria**:
  - All retained skeleton directories exist relative to the repo root.
...
- **Location**:
  - `docs/plans/2026-05-20-01-skeleton-and-schema/`
