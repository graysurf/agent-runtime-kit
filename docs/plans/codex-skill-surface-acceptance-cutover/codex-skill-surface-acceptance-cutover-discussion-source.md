...
- Recommended plan: docs/plans/codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-plan.md
- Recommended execution state: docs/plans/codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-execution-state.md
...
- [F6] Existing `docs/plans/codex-skill-discovery-cutover/` documents the
...
- `docs/plans/codex-skill-discovery-cutover/codex-skill-discovery-cutover-discussion-source.md`
...
Create
`docs/plans/codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-plan.md`
