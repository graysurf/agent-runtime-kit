...
`docs/plans/codex-skill-discovery-cutover/` for Sprint 1 preflight semantics.
...
- Primary source: docs/plans/codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-discussion-source.md
...
- Commands:
  ...
  - `plan-tooling validate --file docs/plans/codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-plan.md --format text --explain`
...
- **Location**:
  - `docs/source/nils-cli-surface.md`
  - `docs/plans/codex-skill-surface-acceptance-cutover/codex-skill-surface-acceptance-cutover-execution-state.md`
...
- **Validation**:
  ...
  - `plan-tooling validate --file docs/plans/codex-skill-discovery-cutover/codex-skill-discovery-cutover-plan.md --format text`
