...
- Primary source: docs/plans/forge-label-taxonomy/forge-label-taxonomy-discussion-source.md
...
- **Location**:
  - `docs/plans/forge-label-taxonomy/forge-label-taxonomy-execution-state.md`
