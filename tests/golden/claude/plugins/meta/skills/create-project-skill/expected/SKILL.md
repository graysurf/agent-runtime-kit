...
```bash
$HOME/.claude/plugins/meta/skills/create-project-skill/scripts/create-project-skill.sh <skill-name> --description "One-line description."
```
...
```bash
$HOME/.claude/plugins/meta/skills/create-project-skill/scripts/create-project-skill.sh <skill-name> --codex-only
```
...
```bash
$HOME/.claude/plugins/meta/skills/create-project-skill/scripts/create-project-skill.sh --bridge-only
```

Optional support surfaces are explicit:

```bash
$HOME/.claude/plugins/meta/skills/create-project-skill/scripts/create-project-skill.sh <skill-name> --with-script --with-tests --with-wrapper <command>
```
