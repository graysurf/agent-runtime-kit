...
- The topic-radar script is available for source acquisition, ranking, cache, and JSON output through its portable skill alias
  (reporting.topic-radar) and rendered script reference ($HOME/.hermes/plugins/reporting/skills/topic-radar/scripts/topic-radar.sh).
...
3. Choose the topic-radar query.
   ...
   - Focused topic:
     ...
     ```bash
     $HOME/.hermes/plugins/reporting/skills/topic-radar/scripts/topic-radar.sh --preset ai-news --format json --topic "<topic>"
     ```

   - Broad scan across research, open source, markets, and model ecosystem:

     ```bash
     $HOME/.hermes/plugins/reporting/skills/topic-radar/scripts/topic-radar.sh --preset radar --format json
     ```

   - Monthly trend archive:

     ```bash
     $HOME/.hermes/plugins/reporting/skills/topic-radar/scripts/topic-radar.sh --preset radar --report monthly --month 2026-01 --format json
     ```

   - Partial current-month trend archive:

     ```bash
     $HOME/.hermes/plugins/reporting/skills/topic-radar/scripts/topic-radar.sh --preset radar --from 2026-05-01 --to 2026-05-15 --format json
     ```
